    ...
    <footer className="footer-arun">
      <div className="footer-row">
        ...
        <div className="brand-col">
          ...
          <address>
            CJ99+XR5, Ganesh Colony, Zakir Hussain Colony, Hudco Colony, Gadag-Betigeri, Gadag-Betageri, Karnataka 582103
          </address>
          <div className="footer-email">
            <a href="mailto:info@arundaya.com">arunodaya.pslp.school@gmail.com</a>
          </div>
        </div>
