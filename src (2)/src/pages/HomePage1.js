...
import "./ContactModal.css"; // Add this CSS file for modal styles (see below)
        ...
        <div className="modalBody">
          <div className="contactCardGroup">
            <div className="contactCard">
              <span className="contactIcon"><img src="/map-icon.svg" alt="Map icon" /></span>
              <h3>Our Head Office</h3>
              <p>Kerala Rehabilitation Institute for the Physically Affected (KRIPA)</p>
              <p>Chunangamvely, Erumathala P.O.,<br />Aluva 683112 Kerala, India</p>
            </div>
            <div className="contactCard dark">
              <span className="contactIcon"><img src="/phone-icon.svg" alt="Phone icon" /></span>
              <h3>Our Phone</h3>
              <p>9539839953<br />9074241011<br />0484-2838153</p>
            </div>
            <div className="contactCard">
              <span className="contactIcon"><img src="/mail-icon.svg" alt="Mail icon" /></span>
              <h3>Our Mail</h3>
              <p>
